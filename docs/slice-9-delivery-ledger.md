...
| S9-DEF-018 | P3 | W5 | `FORCE_COOLDOWN` חוקי ב־DB אך נדחה ב־TypeScript | VERIFIED | §10, `S9-DEF-018` | `docs/evidence/slice-9/w5/S9-DEF-018.md` | pending | real RPC row → skip ניטרלי; אין provider/apply/finalize/run; copy cooldown ייעודי. ‏35/35 focused, ‏584/584 Vitest ו־1427/1427 DB עברו בלי הרחבת admin allowlist. |

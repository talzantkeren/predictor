...
| S9-DEF-001 | P1 | W2 | recovery suppresses and misclassifies errors | IMPLEMENTED | §10, `S9-DEF-001` | `docs/evidence/slice-9/w2/S9-DEF-001.md` | pending W2 commit | Typed allowlisted outcomes ו־account-neutral copy; 96/96 focused Vitest ו־6/6 Mailpit Playwright ב־Desktop/Mobile עברו. SHA נקבע ב־commit הראיה העוקב. |
| S9-DEF-004 | P1 | W2 | Hosted confirmation/recovery אינו בר־הדגמה אמינה | OWNER_ACTION_REQUIRED | §10, `S9-DEF-004` | `docs/evidence/slice-9/w2/S9-DEF-004.md` | pending W2 commit | אין credential מאושר ל־delivery או disposable recipient; אין claim על Hosted pass. הוראות owner מדויקות ו־Production/Local origins נשמרו בראיה. |
...
| S9-DEF-007 | P2 | W3 | מסך הגדרות ליגה אינו משנה הגדרות | NOT_STARTED | §10, `S9-DEF-007` | `docs/evidence/slice-9/w3/S9-DEF-007.md` | — | Allowed fields בלבד, rule versioning אטומי ואכיפת lock בזמן DB. |
| S9-DEF-008 | P2 | W3 | אין פעולה להסרת manual override | NOT_STARTED | §10, `S9-DEF-008` | `docs/evidence/slice-9/w3/S9-DEF-008.md` | — | Clear צר, מורשה, audited ו־idempotent שאינו מוחק result. |
| S9-DEF-009 | P2 | W3 | hard caps משמשים בטעות כשלמות נתונים והרשאה | NOT_STARTED | §10, `S9-DEF-009` | `docs/evidence/slice-9/w3/S9-DEF-009.md` | — | exact authorization נפרד מ־keyset pagination עם cursor/hasMore. |

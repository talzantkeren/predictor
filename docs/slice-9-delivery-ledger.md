...
| S9-DEF-022 | P3 | W6 | פערי נגישות קטנים ב־loading/forms/targets | OWNER_ACTION_REQUIRED | §10, `S9-DEF-022` | `docs/evidence/slice-9/w6/S9-DEF-022.md` | PENDING | semantics/focus/name/alert/contrast/44px עברו unit+Playwright; in-app Browser לא שינה native zoom ולכן owner חייב לבצע Chrome Zoom=200% על candidate SHA לפי הראיה. |

...
| S9-REQ-001 | P1 | W4 | מימוש lifecycle מלא דרך המוצר | IN_PROGRESS | §11, `S9-REQ-001` | `docs/evidence/slice-9/w4/S9-REQ-001.md` | `ffd4233533b535f6495b951e7a97b65557084014`, `efba7ae597d46dd05d48076840f8a9f0f86a42b0` | checkpoint 2/8: סכימת lifecycle, ‏RLS/grants, ‏21/21 regression, ‏1203/1203 DB, lint, types drift ו־typecheck עברו; runtime, races ו־E2E עדיין פתוחים. |

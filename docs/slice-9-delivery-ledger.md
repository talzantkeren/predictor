...
ממוזג; לא בוצעו merge, ‏Production deploy או promotion. ב־checkpoint המקורי
לא נערך נתיב תחת `presentation/`; בעדכון 29.8 נערכו רק מסמכי התסריט והחזרה,
לא הבינאריים. קובצי המשתמש שהיו modified מראש נשארו מחוץ לכל commit.

...
| S9-REQ-001 | P1 | W4 | מימוש lifecycle מלא דרך המוצר | IN_PROGRESS | §11, `S9-REQ-001` | `docs/evidence/slice-9/w4/S9-REQ-001.md` | — | checkpoint 1/8: ‏`architecture.md` §10.2 סונכרן עם PDEC-003; runtime, races ו־E2E עדיין פתוחים. |

...
| S9-DEF-013 | P2 | W7 | ספר הפרויקט derived סותר את המקור הקנוני | VERIFIED | §10, `S9-DEF-013` | `docs/evidence/slice-9/w7/S9-DEF-013.md` | PENDING | source/workflow ו־regeneration דטרמיניסטיים; ‏624/624 Vitest, ‏1443/1443 DB ו־28/28 E2E נמדדו; 5/5 עמודים נבדקו ב־Word/Poppler ללא clipping או overlap. |

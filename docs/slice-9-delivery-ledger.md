...
| S9-DEF-011 | P2 | W5 | `Retry-After` ארוך מסווג timeout ומאבד backoff | VERIFIED | §10, `S9-DEF-011` | `docs/evidence/slice-9/w5/S9-DEF-011.md` | pending | ברירת המחדל 45/120/date מסווגת מיד RATE_LIMITED ללא sleep; quota/hint בטוחים נשמרים; ‏29/29 focused, ‏577/577 Vitest, ‏77/77 focused pgTAP ו־1411/1411 DB עברו. |

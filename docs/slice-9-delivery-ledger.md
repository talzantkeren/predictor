...
| S9-DEF-010 | P2 | W5 | targeted sync יכול להרעיב catalog/reconciliation | VERIFIED | §10, `S9-DEF-010` | `docs/evidence/slice-9/w5/S9-DEF-010.md` | — | רוטציה least-recently-attempted מבטיחה כל plan due בתוך 3 claims זכאים; live ראשון במכסת 20; ‏9/9 focused ו־1409/1409 DB מלא עברו. |

...
| S9-DEF-014 | P3 | W7 | Redirect allowlist ו־README אינם מתארים את Preview הנוכחי | NOT_STARTED | §10, `S9-DEF-014` | `docs/evidence/slice-9/w7/S9-DEF-014.md` | — | תיעוד סופי כאן; בדיקת Production/Local ו־config child מתבצעת לצד W2. |

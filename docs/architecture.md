...
כל count וכל רשימת דירוג מוגבלים ל־500 ונבדקים כ־safe integers; חריגה או ערך
malformed מחזירים error state סגור ולא דוח חלקי. חבר רגיל, משתמש זר, מנהל של
ליגה אחרת ומנהל מערכת שאינו מנהל הליגה מקבלים את אותה תשובת not-found.

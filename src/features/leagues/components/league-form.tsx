  ...
  return (
    <form action={formAction} className="space-y-8" noValidate>
      ...
      <div className="grid min-w-0 gap-5 sm:grid-cols-2">
        <div className="min-w-0 sm:col-span-2">
          ...
          <input
            ...
            aria-describedby={state.fieldErrors?.name ? "league-name-error" : "league-name-help"}
        ...
        <div className="min-w-0 sm:col-span-2">
          ...
          <textarea
            ...
            aria-describedby={state.fieldErrors?.description ? "league-description-error" : "league-description-help"}
        ...
        <div className="min-w-0">
          ...
          <input
            ...
            aria-describedby={state.fieldErrors?.demoEntryFeeAgorot ? "demo-entry-fee-error" : "demo-entry-fee-help"}
            className="mt-2 w-full min-w-0 rounded-lg border border-slate-300 px-3 py-2.5 outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
          />
        ...
        <div className="min-w-0 sm:col-span-2">
          ...
          <textarea
            ...
            aria-describedby={state.fieldErrors?.demoPaymentInstructions ? "demo-payment-instructions-error" : "demo-payment-instructions-help"}
            className="mt-2 w-full min-w-0 resize-y rounded-lg border border-slate-300 px-3 py-2.5 outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
          />
      ...
      <fieldset className="rounded-xl border border-slate-200 p-4 sm:p-5">
        ...
        <p className="mb-4 text-sm leading-6 text-slate-600">
          המיקומים חייבים להתחיל ב־1 ולהיות רצופים. סכום האחוזים חייב להיות 100% בדיוק.
        </p>
        ...
        <FieldError id="prizes-error" messages={state.fieldErrors?.prizes ?? state.fieldErrors?.form} />

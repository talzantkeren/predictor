    ...
    <form action={formAction} className="space-y-8" noValidate>
      ...
      <div className="grid min-w-0 gap-5 sm:grid-cols-2">
        <div className="min-w-0 sm:col-span-2">
          <label htmlFor="league-name" className="block text-sm font-semibold text-ink">
            שם הליגה
          </label>
          <input
            id="league-name"
            ...
            className="mt-2 w-full min-w-0 rounded-lg border border-control-border px-3 py-2.5 outline-none transition focus:border-focus focus:ring-2 focus:ring-navy-200"
          />
          <p id="league-name-help" className="mt-1 text-sm text-ink-muted">
            בין 3 ל־80 תווים.
          </p>
        ...
        <div className="min-w-0 sm:col-span-2">
          <label htmlFor="league-description" className="block text-sm font-semibold text-ink">
          ...
          <textarea
            ...
            className="mt-2 w-full min-w-0 resize-y rounded-lg border border-control-border px-3 py-2.5 outline-none transition focus:border-focus focus:ring-2 focus:ring-navy-200"
          />
          <p id="league-description-help" className="mt-1 text-sm text-ink-muted">
            עד 500 תווים.
          </p>
        ...
        <div className="min-w-0">
          <label htmlFor="league-season" className="block text-sm font-semibold text-ink">
            עונה
          </label>
          <select
            id="league-season"
            ...
            className="mt-2 w-full min-w-0 rounded-lg border border-control-border bg-white px-3 py-2.5 outline-none transition focus:border-focus focus:ring-2 focus:ring-navy-200"
          >
            {seasons.map((season) => (
        ...
        <div className="min-w-0">
          <label htmlFor="demo-entry-fee" className="block text-sm font-semibold text-ink">
          ...
          <input
            ...
            className="mt-2 w-full min-w-0 rounded-lg border border-control-border px-3 py-2.5 outline-none transition focus:border-focus focus:ring-2 focus:ring-navy-200"
          />
          <p id="demo-entry-fee-help" className="mt-1 text-sm text-ink-muted">
        ...
        <div className="min-w-0 sm:col-span-2">
          <label htmlFor="demo-payment-instructions" className="block text-sm font-semibold text-ink">
          ...
          <textarea
            ...
            className="mt-2 w-full min-w-0 resize-y rounded-lg border border-control-border px-3 py-2.5 outline-none transition focus:border-focus focus:ring-2 focus:ring-navy-200"
          />
          <p id="demo-payment-instructions-help" className="mt-1 text-sm text-ink-muted">
      ...
      >
        ...
        <p id="league-prizes-help" className="mb-4 text-sm leading-6 text-ink-secondary">
        ...
        <div className="space-y-4">
          {prizeRows.map((row, index) => {
            ...
            return (
              <div key={row.key} className="grid min-w-0 gap-3 rounded-lg bg-surface-subtle p-3 sm:grid-cols-[1fr_1fr_auto] sm:items-end">
                <div className="min-w-0">
                  <label htmlFor={`prize-position-${row.key}`} className="block text-sm font-semibold text-ink">
                    מיקום
                  </label>
                  ...
                  <input
                    ...
                    className="mt-2 w-full min-w-0 rounded-lg border border-control-border bg-white px-3 py-2.5 text-locked-900 outline-none transition focus:border-focus focus:ring-2 focus:ring-navy-200"
                  />
                  <FieldError id={`prize-position-${row.key}-error`} messages={positionError} />
                </div>

                <div className="min-w-0">
                  <label htmlFor={`prize-percentage-${row.key}`} className="block text-sm font-semibold text-ink">
                    אחוז
                  </label>
                  <input
                ...
                <button
                  ...
                  className="rounded-lg border border-line px-3 py-2.5 text-sm font-semibold text-navy-700 hover:bg-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:cursor-not-allowed disabled:opacity-40"
                >
                  הסרה
                </button>
              </div>
        ...
        <button
          ...
          className="mt-4 rounded-lg border border-navy-200 px-4 py-2 text-sm font-semibold text-navy-700 hover:bg-navy-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:opacity-50"
        >
          הוספת מיקום פרס
        </button>
      </fieldset>
      ...
      <div className="rounded-xl border border-warning-200 bg-warning-50 p-4 text-sm leading-6 text-warning-900" role="note">
      ...
      <button
        ...
        className="min-h-11 w-full rounded-lg bg-action px-5 py-3 font-semibold text-white transition hover:bg-action-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:cursor-wait disabled:opacity-60 sm:w-auto"
      >
